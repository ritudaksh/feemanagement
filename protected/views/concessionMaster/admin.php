...
$('.search-form form').submit(function(){
	$('#concession-master-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
  ...
  'deleteConfirmation'=>"Are You Sure you want to delete this concession?",
