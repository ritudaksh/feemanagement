...
<!-- add excel sheet begins here-->
<p style="text-align:right">
       <?php echo CHtml::link('Export all Buses Routes to Excel','index.php?r=busfeesMaster/busfeesmasterexcel',array('class'=>'btn btn-success')); ?>
 </p>
<!-- add excel sheet ends here-->
