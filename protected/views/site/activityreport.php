...
<th id="th1">Class</th><th id="th1">Section</th><th id="th1">Activity Fees unpaid for months</th>
</tr>
...
var url="<?php echo Yii::app()->createUrl('site/ActivityDefaultersData'); ?>";
console.log(url);
$.ajax({
 type: "GET",
        url:url,
...
window.location.href = "<?php echo Yii::app()->createUrl('site/Activityexcel'); ?>&datefrom="+datefrom+"&dateto="+dateto+"&c="+c+"&year="+year;*/
