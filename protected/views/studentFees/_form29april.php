...
<div class="fees1" style="margin-top:10px;">
	...
	<td valign="top">
		Admission No.
		<?php if(isset($model->studentFee->addmission_no)){ ?>
		<input type="text" value="<?php echo $model->studentFee->addmission_no; ?>" id="admno" name="admno" readonly="true"/>
	<?php } else{ ?><input type="text" value ="" readonly="readonly" id="admno" name="admno"> <?php }?>
...
var b= document.getElementById('monthfees').value; 
var feesmonth= $('#monthfees').val().split(",");
