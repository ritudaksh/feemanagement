...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'filter'=>$model,
	//'rowCssClassExpression' => '$data->cheque_status == "Rejected" ? "rejected" : ""',
	'rowCssClassExpression' => '($row%2 ? $this->rowCssClass[1] : $this->rowCssClass[0] ) ." ".($data->cheque_status == "Rejected" ? "rejected" : "")',
	'columns'=>array(
